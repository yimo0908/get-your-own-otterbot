...
4) 根据实际情况及注释编辑`.\OneBot\config.yml`文件
```
# 版本
version: 1.0.5
# 主人QQ号
...
5) 每个姬气人都可以设置多个 正向WS 反向WS HTTP 服务，实在不懂[加群](https://github.com/Yiwen-Chan/OneBot-YaYa)问或者提 [issue](https://github.com/Yiwen-Chan/OneBot-YaYa/issues) 
